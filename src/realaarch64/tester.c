...
extern void
sgemm_kernel_8x8_neon_fullyunroll(int kc,
...
int main() {
    ...
    sgemm_L2_kernel(M, N, K, 1.0, A_buffer, B_buffer, 1.0, C1, 1, M);
    cblas_sgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, M, N, K, 1.0, A, K, B, N, 1.0, C2, N);
